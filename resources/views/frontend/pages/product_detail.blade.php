									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @php 
                                                    $after_discount=(Helper::price($product_detail)-((Helper::price($product_detail)*$product_detail->discount)/100));
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,2)}}</span>{{ Session::get('currency')}} @if($product_detail->discount>0)<s>{{number_format(Helper::price($product_detail),2)}}</s> @endif</p>
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
												    ...
												    <!-- Shops -->
												    <div class="size">
													    <h4>Shops <span class="text-danger">*</span></h4>
													    <ul>
														    <select name="shop" id="shop" required>
													        @foreach($product_detail->shops as $sh)
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12">
					...
					@foreach(Helper::product_recommend($product_detail->id) as $data)
					    @if(!is_null($data))  
