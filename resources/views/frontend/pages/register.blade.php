                    ...
                    <div class="login-form">
                        ...
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div >
                                        <label >Role <span><i class="text-danger">*</i></span></label>
                                        <br>
                                        <label style="display:block"><input type="radio" name="role" value="customer">  Customer</label>
                                        <label style="display:block"><input type="radio" name="role" value="user">  Seller</label>
                                        @error('role')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
