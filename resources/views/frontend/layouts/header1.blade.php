        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-12" >        
                   <!-- <a href="{{route('home')}}"><img src="{{url('backend/img/logo.png')}}" alt="logo"></a> -->
                </div>
                <!--/ End Logo -->
                ...
                <select id="change_currency">
                    <option value="SYP" >Currency</option>
                    @foreach(Helper::getAllCurrency() as $currency)
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='shop' ? 'active' : ''}}"><a href="{{route('shop')}}">Shops</a></li>									
