        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <!-- Top Left -->
                    <div class="top-left">
                        <h1 style="color:#5ca08e"><a href="{{route('home')}}">Wardrobe Loop</a></h1>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            {{Helper::getHeaderCurrency()}}
                                            <li><a href="{{route('wishlist')}}" class="single-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                                            <li><a href="{{route('cart')}}" class="single-icon"><i class="ti-bag" aria-hidden="true"></i></a></li>
